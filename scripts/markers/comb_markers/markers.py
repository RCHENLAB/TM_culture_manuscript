...
if __name__ == "__main__":
    ...
    marker_gene_list = ['CALB2','UCHL1','SCG2','GAP43','MLANA','PMEL','MITF','TRPM1','TYR','MBP','MPZ','PLP1','LGI4','CDH19','CD27','CD79A','MZB1','LYVE1','CD68','CXCL8','IL1B','TREM2','RGS13','KIT','CD2','CD3D','IL7R','TRAC','CA3','MGARP','ADRB2','SLC2A1','IGFBP2','COL14A1','ADH1B','FBLN2','COL1A2','COL6A1','TNXB','TIMP2','FBLN1','DCN','PCOLCE','PLVAP','FLT4','PROX1','ACKR1','AQP1','SELE','MMRN1','PECAM1','VWF','ALPL','CLDN5','TFF3','PLAT','FN1','POSTN','CCL21','CDH5','ANGPTL7','PDPN','CEMIP','MYOC','CYTL1','CHI3L1','NEB','RSPO4','FMOD','NELL2','BMP5','MGP','RARRES1','FABP4','TMEFF2','PPP1R1B','BAMBI','CHRM3','DES','CNN1','MYH11','MYLK','NDUFA4L2','ATP2A1']
